...
{
    //cout<<"This is gmxlib/nonbonded/nonbonded.cpp and the function gmx_nonbonded_setup is called!"<<endl;
...
{
    //cout<<"This is gmxlib/nonbonded/nonbonded.cpp and the function gmx_nonbonded_set_kernel_pointers is called!"<<endl;
    const char *     elec;
    const char *     elec_mod;
    const char *     vdw;
    const char *     vdw_mod;
...
{
    //cout<<"This is gmxlib/nonbonded/nonbonded.cpp and the function do_nonbonded.cpp is called!"<<endl;
    t_nblist *        nlist;
    int               n, n0, n1, i, i0, i1;
    t_nblists *       nblists;
