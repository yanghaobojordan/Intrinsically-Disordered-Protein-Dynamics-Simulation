...
{
    //cout<<"This is listed-forces/listed-forces.cpp and the function calc_one_bond is called!"<<endl;
...
calcBondedForces(const t_idef     *idef,
                 ...
                 int              *global_atom_index)
{
    //cout<<"This is listed-forces/listed-forces.cpp and the function calcBondedForces is called!"<<endl;
...
void calc_listed(const t_commrec             *cr,
                 ...
                 int force_flags)
{
    //cout<<"This is listed-forces/listed-forces.cpp and the function calc_listed is called!"<<endl;
    struct bonded_threading_t *bt;
    gmx_bool                   bCalcEnerVir;
    const  t_pbc              *pbc_null;
        ...
        fcd->disres.nres > 0)
    {
        ...
        if (idef->il[F_POSRES].nr > 0)
        {
            //cout<<"In calc_listed, line 532 is called"<<endl;
            //NOT Called
        ...
        {
            //cout<<"in calc_listed, line 539 is called"<<endl;
            //NOT called
        ...
        if (fcd->orires.nr > 0)
        {
             ...
             */
            //cout<<"in calc_listed line 553 is called"<<endl;
            //NOT called
        ...
        {
            //cout<<"in calc_listed, line 563 is called"<<endl;
            //NOT called
            calc_disres_R_6(cr,
                            idef->il[F_DISRES].nr,
    ...
    if (bt->haveBondeds)
    {
        //cout<<"in calc_listed, line 576 is called"<<endl;
        //YES
...
do_force_listed(struct gmx_wallcycle        *wcycle,
                ...
                int                          flags)
{
    //cout<<"This is listed-forces/listed-forces.cpp and the function do_force_listed is called!"<<endl;
    ...
    //cout<<"calc_listed is called"<<endl;
    //YES
