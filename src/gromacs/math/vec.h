...
{
    //cout<<"static inline void rvec_add"<<endl;
    real x, y, z;
...
{
    //cout<<"static inline void dvec_add"<<endl;
    double x, y, z;
...
{
    //cout<<"static inline void ivec_add"<<endl;
    int x, y, z;
...
{
    real x, y, z;
    //cout<<"vec.h Before Add"<<endl;
    //cout<<"a[XX] "<<a[XX]<<" a[YY] "<<a[YY]<<" a[ZZ] "<<a[ZZ]<<endl;
    //cout<<"b[XX] "<<b[XX]<<" b[YY] "<<b[YY]<<" b[ZZ] "<<b[ZZ]<<endl;
...
{
    //cout<<"static inline void dvec_inc"<<endl;
    double x, y, z;
...
{
    //cout<<"static inline void rvec_sub"<<endl;
    real x, y, z;
...
{
    //cout<<"static inline void dvec_sub"<<endl;
    double x, y, z;
...
{
    //cout<<"static inline void rvec_dec"<<endl;
    real x, y, z;
...
{
    //cout<<"static inline void copy_rvec"<<endl;
    b[XX] = a[XX];
    b[YY] = a[YY];
    b[ZZ] = a[ZZ];
}
...
{
    //cout<<"static inline void copy_rvec_to_dvec"<<endl;
    b[XX] = a[XX];
    b[YY] = a[YY];
    b[ZZ] = a[ZZ];
}
...
{
    //cout<<"static inline void copy_dvec_to_rvec"<<endl;
    b[XX] = a[XX];
    b[YY] = a[YY];
    b[ZZ] = a[ZZ];
}
...
{
    //cout<<"static inline void copy_rvecn"<<endl;
    int i;
...
{
    //cout<<"static inline void copy_dvec"<<endl;
    b[XX] = a[XX];
    b[YY] = a[YY];
    b[ZZ] = a[ZZ];
}
...
{
    //cout<<"static inline void copy_ivec"<<endl;
    b[XX] = a[XX];
    b[YY] = a[YY];
    b[ZZ] = a[ZZ];
}
...
{
    //cout<<"static inline void ivec_sub"<<endl;
    int x, y, z;
...
{
    //cout<<"static inline void copy_mat"<<endl;
    copy_rvec(a[XX], b[XX]);
    copy_rvec(a[YY], b[YY]);
    copy_rvec(a[ZZ], b[ZZ]);
}
...
{
    //cout<<"static inline void svmul"<<endl;
    v2[XX] = a*v1[XX];
    v2[YY] = a*v1[YY];
    v2[ZZ] = a*v1[ZZ];
}
...
{
    //cout<<"static inline void dsvmul"<<endl;
    v2[XX] = a*v1[XX];
    v2[YY] = a*v1[YY];
    v2[ZZ] = a*v1[ZZ];
}
...
{
    //cout<<"static inline real distance2"<<endl;
...
static inline void clear_rvec(rvec a)
{
     ...
     */
    //cout<<"static inline void clear_rvec"<<endl;
    a[XX] = 0.0;
    a[YY] = 0.0;
    a[ZZ] = 0.0;
}
...
static inline void clear_dvec(dvec a)
{
     ...
     * when we use a const real variable
     */
    //cout<<"static inline void clear_dvec"<<endl;
    a[XX] = 0.0;
    a[YY] = 0.0;
    a[ZZ] = 0.0;
}
...
{
    //cout<<"static inline void clear_ivec"<<endl;
    a[XX] = 0;
    a[YY] = 0;
    a[ZZ] = 0;
}
...
{
    //cout<<"static inline void clear_rvecs"<<endl;
    int i;
...
{
    //cout<<"static inline void clear_mat"<<endl;
    const real nul = 0.0;
...
{
    //cout<<"static inline double dnorm"<<endl;
...
{
    //cout<<"static inline real cos_angle"<<endl;
    /*
     *                  ax*bx + ay*by + az*bz
     * cos-vec (a,b) =  ---------------------
     *                      ||a|| * ||b||
...
{
    //cout<<"static inline void cprod"<<endl;
...
{
    //cout<<"static inline void dcprod"<<endl;
    c[XX] = a[YY]*b[ZZ]-a[ZZ]*b[YY];
    c[YY] = a[ZZ]*b[XX]-a[XX]*b[ZZ];
    c[ZZ] = a[XX]*b[YY]-a[YY]*b[XX];
}
...
{
    //cout<<"static inline real gmx_angle"<<endl;
    rvec w;
    real wlen, s;
...
{
    //cout<<"static inline double gmx_angle_between_dvecs"<<endl;
    dvec   w;
    double wlen, s;
...
{
    //cout<<"static inline void mmul_ur0"<<endl;
...
{
    //cout<<"static inline void mmul"<<endl;
...
{
    //cout<<"static inline void transpose"<<endl;
...
{
    //cout<<"static inline void tmmul"<<endl;
...
{
    //cout<<"static inline void mtmul"<<endl;
...
{
    //cout<<"static inline real det"<<endl;
...
{
    //cout<<"static inline void m_add"<<endl;
    dest[XX][XX] = a[XX][XX]+b[XX][XX];
...
{
    //cout<<"static inline void m_sub"<<endl;
    dest[XX][XX] = a[XX][XX]-b[XX][XX];
    dest[XX][YY] = a[XX][YY]-b[XX][YY];
    dest[XX][ZZ] = a[XX][ZZ]-b[XX][ZZ];
    dest[YY][XX] = a[YY][XX]-b[YY][XX];
...
{
    //cout<<"static inline void msmul"<<endl;
...
{
    //cout<<"static inline void mvmul"<<endl;
...
{
    //cout<<"static inline void mvmul_ur0"<<endl;
    dest[ZZ] = a[ZZ][XX]*src[XX]+a[ZZ][YY]*src[YY]+a[ZZ][ZZ]*src[ZZ];
...
{
    //cout<<"static inline void tmvmul_ur0"<<endl;
...
{
    //cout<<"static inline void unitv"<<endl;
    real linv;
...
{
    //cout<<"static inline real trace"<<endl;
