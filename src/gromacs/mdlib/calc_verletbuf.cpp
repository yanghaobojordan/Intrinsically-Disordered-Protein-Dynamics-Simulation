...
static void get_verlet_buffer_atomtypes(const gmx_mtop_t      *mtop,
                                        ...
                                        int                   *n_nonlin_vsite)
{
    //cout<<"mdlib/calc_verletbuf.cpp; get_verlet_buffer_atomtype called"<<endl;
    //This is Called!
    verletbuf_atomtype_t          *att;
    int                            natt;
        ...
        for (ft = F_CONSTR; ft <= F_CONSTRNC; ft++)
        {
            ...
            for (i = 0; i < il->nr; i += 1+NRAL(ft))
            {
                ...
                if (atoms->atom[a2].m > prop[a1].con_mass)
                {
                    ...
                    //Called
                    //cout<<"a2 "<<a2<<endl;
		    //cout<<"Number of atoms "<<atoms->nr<<endl;
                    //cout<<"Number of resiinfo entries "<<atoms->nres<<endl;
                    prop[a1].con_mass = atoms->atom[a2].m;
                    prop[a1].con_len  = ip->constr.dA;
                    //cout<<"Atomic Number "<<atoms->atom[a2].atomnumber<<endl;
                    //cout<<"Atom name "<<*(atoms->atomname[a2])<<endl;
                    //cout<<"Residue name "<<*(atoms->resinfo[a2].name)<<endl;
                    //cout<<"Residue Number  "<<atoms->resinfo[a2].nr<<endl;
                    //cout<<"############################################"<<endl;
                }
                if (atoms->atom[a1].m > prop[a2].con_mass)
                {
                    ...
                    //cout<<"Atomic Number "<<atoms->atom[a1].atomnumber<<endl;
                    //cout<<"Atom name "<<*(atoms->atomname[a1])<<endl;
                    //cout<<"Residue name "<<*(atoms->resinfo[a1].name)<<endl;
                    //cout<<"Residue Number  "<<atoms->resinfo[a1].nr<<endl;
                    //cout<<"$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$"<<endl;
                }
            }
        }
    ...
    *att_p  = att;
    *natt_p = natt;
    //cout<<"The number of resinfo entries "<<atoms->nres<<endl;
